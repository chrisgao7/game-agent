...
"""
    ...
    def _update_state(self, player_input: str, emotion: str):
        ...
        # 更新关系值
        if emotion == "positive":
            self.profile.relationship_with_player = min(100, self.profile.relationship_with_player + 3)
        elif emotion == "negative":
            self.profile.relationship_with_player = max(-100, self.profile.relationship_with_player - 5)
